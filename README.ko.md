...
| 세탁기 (`WW/WD/WF/WV/WA*`) | 미검증. 동작상태·진행률·남은시간, 세탁온도·탈수·헹굼, 누적수량, **현재 코스 이름**(코스 표 2종, 세탁 104종. 일체형 세탁건조기는 세탁·건조 코스를 각각 표시) |
| 건조기 (`DV*`) | 미검증. 동작상태·진행률·남은시간, 건조강도, 주름방지, **현재 코스 이름**(코스 표 2종, 건조 56종) |
| 식기세척기 (`ADW`, `DW*`) | 미검증. 동작상태·진행률, 살균, 가열건조, 누적수량, 사운드, **현재 코스 이름**(19종) |
