...
| Dryer (`DV*`) | Unverified. Machine state, progress, remaining time, dry level, wrinkle prevention, washes until drum clean, **the running cycle by name** (two course tables, 69 dry cycles) |
