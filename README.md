...
| Washer (`WW/WD/WF/WV/WA*`) | Unverified. Machine state, progress, remaining time, wash temperature, spin, rinse, cumulative water, **the running cycle by name** (71 wash cycles; a one-body washer-dryer reports both its wash and its dry cycle) |
| Dryer (`DV*`) | Unverified. Machine state, progress, remaining time, dry level, wrinkle prevention, **the running cycle by name** (27 dry cycles) |
