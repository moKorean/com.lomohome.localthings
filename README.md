...
| Washer (`WW/WD/WF/WV/WA*`) | Unverified. Machine state, progress, remaining time, wash temperature, spin, rinse, cumulative water, **the running cycle by name** (two course tables, 104 wash cycles; a one-body washer-dryer reports both its wash and its dry cycle) |
| Dryer (`DV*`) | Unverified. Machine state, progress, remaining time, dry level, wrinkle prevention, **the running cycle by name** (two course tables, 56 dry cycles) |
| Dishwasher (`ADW`, `DW*`) | Unverified. Machine state, progress, sanitize, heated dry, cumulative water, sound, **the running cycle by name** (19 cycles) |
